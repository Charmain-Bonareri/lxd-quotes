...
export class QuotesComponent implements OnInit {
  ...
  quotes:Quote[]= [
    ...
    new Quote(5,  '"Art has to move you and design does not, unless its’s a good design for a bus."', '- David Hockney', 'Anastacia',80,0, new Date(2019,6,9)),
    new Quote(6,  '"The life of a designer is a life of a fight, fight against the ugliness and dullness."', '- Massimo Vignelli', 'Lawrencio', 98,2,new Date(2021,7,18)),
  ];
