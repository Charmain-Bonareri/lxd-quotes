...
export class QuotesComponent implements OnInit {
  ...
  quotes:Quote[]= [
    ...
    {id:5, quotetitle:'Design', quotecontent:'Art has to move you and design does not, unless its’s a good design for a bus', author:'David Hockney',submittedquote:'Anastacia'},
